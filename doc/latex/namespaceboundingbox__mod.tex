...
66     temp\_str(1)=self%pt%x
67     temp\_str(2)=self%pt%y
68     temp\_str(3)=self%pt%z
...
70     temp\_str(1)=self%size%x
71     temp\_str(2)=self%size%y
72     temp\_str(3)=self%size%z
...
74     
75     \textcolor{keyword}{call }log%put(outext,.false.)
76 
\end{DoxyCode}
