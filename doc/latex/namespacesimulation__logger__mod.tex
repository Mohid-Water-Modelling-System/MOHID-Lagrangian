...
105     \textcolor{keyword}{write}(self%log\_unit,\textcolor{stringliteral}{"(A)"}) tologstr%chars()
106     print\textcolor{stringliteral}{'(A)'}, tologstr%chars()
107     
\end{DoxyCode}
