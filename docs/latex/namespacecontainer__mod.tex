...
124     \textcolor{keyword}{allocate}(constructor%value, source=to\_store)
\end{DoxyCode}
...
75     \textcolor{keywordflow}{if} (\textcolor{keyword}{associated}(this%value)) \textcolor{keyword}{deallocate}(this%value)
76     \textcolor{keyword}{nullify}(this%value)
\end{DoxyCode}
...
101     \textcolor{keywordflow}{select type}(v => this%value)
...
89     \textcolor{keyword}{allocate}(this%value, source=to\_store)
\end{DoxyCode}
