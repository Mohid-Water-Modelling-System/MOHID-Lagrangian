...
73         \textcolor{keyword}{call }self%makeRealVel(resolution, testbox, testbackground)
...
205 
\end{DoxyCode}
\mbox{\Hypertarget{namespacesimulationtestmaker__mod_a99df61e4a45020aa1e2d30d33a4e2fa0}\label{namespacesimulationtestmaker__mod_a99df61e4a45020aa1e2d30d33a4e2fa0}} 
...
215     \textcolor{keywordtype}{integer}, \textcolor{keywordtype}{intent(in)} :: res
216     \textcolor{keywordtype}{type}(box), \textcolor{keywordtype}{intent(in)} :: testbox
217     \textcolor{keywordtype}{type}(background\_class), \textcolor{keywordtype}{intent(inout)} :: testbackground
218     \textcolor{keywordtype}{type}(scalar1d\_field\_class), \textcolor{keywordtype}{allocatable}, \textcolor{keywordtype}{dimension(:)} :: testbackgroundims
219     \textcolor{keywordtype}{type}(generic\_field\_class) :: gfield1, gfield2,gfield3
220     \textcolor{comment}{!type(nc\_class),dimension(3) :: nc\_input\_file}
221     \textcolor{keywordtype}{type}(string) :: name, units
222     
223     
224     \textcolor{keywordtype}{type}(ncfile\_class) :: ncFile
225     \textcolor{keywordtype}{type}(string) :: ncFileName
226     \textcolor{keywordtype}{integer} :: i
227     
228     ncfilename = \textcolor{stringliteral}{'MOHID\_Vigo\_20180904\_0000.nc4'}
229     \textcolor{keyword}{call }ncfile%initialize(ncfilename)    
230     \textcolor{keyword}{call }ncfile%getVarDimensions(globals%Var%u, testbackgroundims)
231     \textcolor{keyword}{call }ncfile%getVar(globals%Var%u, gfield1)
232     \textcolor{keyword}{call }ncfile%getVar(globals%Var%v, gfield2)
233     \textcolor{keyword}{call }ncfile%getVar(globals%Var%w, gfield3)
234     \textcolor{keyword}{call }ncfile%finalize()
235     \textcolor{comment}{!do i=1, size(testbackgroundims\_alt)}
236     \textcolor{comment}{!    call testbackgroundims\_alt(i)%print()}
237     \textcolor{comment}{!end do}
238     \textcolor{comment}{!call gfield1%print()}
239    
240     name = \textcolor{stringliteral}{'Real surface velocity field'}
241     testbackground = background(1, name, testbox, testbackgroundims)
242     \textcolor{keyword}{call }testbackground%add(gfield1)
243     \textcolor{keyword}{call }testbackground%add(gfield2)
244     \textcolor{keyword}{call }testbackground%add(gfield3)
245     
246     \textcolor{comment}{!call testbackground%print()}
247 
\end{DoxyCode}
