...
\begin{DoxyCode}
131         \textcolor{keywordtype}{type}(string) :: density
\end{DoxyCode}
...
\begin{DoxyCode}
144         \textcolor{keywordtype}{type}(stringList\_class) :: levelVariants
\end{DoxyCode}
...
\begin{DoxyCode}
132         \textcolor{keywordtype}{type}(string) :: lon
\end{DoxyCode}
...
\begin{DoxyCode}
142         \textcolor{keywordtype}{type}(stringList\_class) :: lonVariants
\end{DoxyCode}
