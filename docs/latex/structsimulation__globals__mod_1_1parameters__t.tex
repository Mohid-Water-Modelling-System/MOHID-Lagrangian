...
\begin{DoxyCode}
36         \textcolor{keywordtype}{real(prec)} :: CFL = 0.5
\end{DoxyCode}
...
\begin{DoxyCode}
41         \textcolor{keywordtype}{type}(datetime) :: EndTime
\end{DoxyCode}
...
\begin{DoxyCode}
40         \textcolor{keywordtype}{type}(datetime) :: StartTime
\end{DoxyCode}
...
\begin{DoxyCode}
38         \textcolor{keywordtype}{real(prec\_time)} :: TimeMax = mv         
\end{DoxyCode}
