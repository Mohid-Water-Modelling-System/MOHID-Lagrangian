...
108     self%ttype = mv
109     \textcolor{keywordflow}{if} (\textcolor{keyword}{allocated}(self%trc)) \textcolor{keyword}{deallocate}(self%trc)
110     \textcolor{keywordflow}{if} (\textcolor{keyword}{allocated}(self%state)) \textcolor{keyword}{deallocate}(self%state)
111     \textcolor{keywordflow}{if} (\textcolor{keyword}{allocated}(self%landMask)) \textcolor{keyword}{deallocate}(self%landMask)
112     \textcolor{keywordflow}{if} (\textcolor{keyword}{allocated}(self%landIntMask)) \textcolor{keyword}{deallocate}(self%landIntMask)
113     \textcolor{keywordflow}{if} (\textcolor{keyword}{allocated}(self%active)) \textcolor{keyword}{deallocate}(self%active)
114     \textcolor{keywordflow}{if} (\textcolor{keyword}{allocated}(self%source)) \textcolor{keyword}{deallocate}(self%source)
115     \textcolor{keywordflow}{if} (\textcolor{keyword}{allocated}(self%id)) \textcolor{keyword}{deallocate}(self%id)
116     self%idx = 1
\end{DoxyCode}
...
Definition at line 58 of file state\+Vector.\+f90.
...
60     
61     newsv%ttype = self%ttype
62     \textcolor{keyword}{allocate}(newsv%state(\textcolor{keyword}{size}(self%state,1), \textcolor{keyword}{size}(self%state,2)))
63     newsv%state = self%state
64     \textcolor{keyword}{allocate}(newsv%landMask(\textcolor{keyword}{size}(self%landMask)))
65     newsv%landMask = self%landMask
66     \textcolor{keyword}{allocate}(newsv%landIntMask(\textcolor{keyword}{size}(self%landIntMask)))
67     newsv%landIntMask = self%landIntMask
68     \textcolor{keyword}{allocate}(newsv%active(\textcolor{keyword}{size}(self%active)))
69     newsv%active = self%active
...
84     \textcolor{keywordflow}{if}(\textcolor{keyword}{allocated}(self%active)) \textcolor{keywordflow}{then}
85         \textcolor{keywordflow}{do} i=1, \textcolor{keyword}{size}(self%active)
86             \textcolor{keywordflow}{if} (\textcolor{keyword}{associated}(self%trc(i)%ptr)) \textcolor{keywordflow}{then}
87                 atracer => self%trc(i)%ptr
88                 \textcolor{keywordflow}{if} (self%active(i)) \textcolor{keywordflow}{then}
89                     atracer%now%active = .true.
90                     \textcolor{keyword}{call }atracer%setStateArray(self%state(i,:))
